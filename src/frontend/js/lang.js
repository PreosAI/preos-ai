...
window.PreosLang = (function () {
  ...
  var strings = {
    es: {
      ...
      section_descripcion:      'Descripción',
      section_detalles:         'Detalles',
      section_calculadora:      'Calculadora',
      section_escuelas:         'Escuelas',
    ...
    en: {
      ...
      section_descripcion:      'Description',
      section_detalles:         'Details',
      section_calculadora:      'Calculator',
      section_escuelas:         'Schools',
      myVisits:                 'My visits',
